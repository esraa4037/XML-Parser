...
void Decompress(string file_name, string newfile_name, string newde_file_name) {
    string  us = "", s, s1;
    charmap  chars;
    charValue* cValue = new charValue;
    priority_queue<charnode*, vector<charnode*>, freqComp> chartree;
...
//        fout1<<us;
        ...
        g = decoding(chartree.top(), outDecomp(us), setNewLines(file_name));
        fout1 << g;
    }
    fout.close();
    fout1.close();
