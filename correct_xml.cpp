...
int main()
{
    ...
    create_correct_xml(s, new_file);
    
    if(is_valid(new_file)){
        cout << "congratulations, you solved the errors successfully." << endl;
    } else {
        cout << "whoops, seems something went wrong." << endl;
    }

    vector<vector<string>> errors = get_correction(new_file);
...
// string s = "  <name>Ahmed Ali</namdfge1>";
// if(is_more_than_one_tag(s)){
//     cout << "more than one tag" << endl;
// } else {
//     cout << "just one" << endl;
// }
